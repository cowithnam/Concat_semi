...
/**
 * Servlet implementation class NotHasClassWantWish
 */
@WebServlet("/addWish")
public class NotHasClassWantWish extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public NotHasClassWantWish() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(result>0) {
			...
			request.setAttribute("errorMsg", "위시리스트 추가에 실패했습니다");
