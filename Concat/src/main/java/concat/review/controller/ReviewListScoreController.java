...
/**
 * Servlet implementation class ReviewListScoreController
 */
@WebServlet("/listScore.re")
public class ReviewListScoreController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReviewListScoreController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Review> list = new ReviewService().scoreList(pi);
